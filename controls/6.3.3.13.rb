...
control 'C-6.3.3.13' do
  ...
  describe 'Ensure file deletion events by users are collected' do
    skip 'TODO[scaffolder]: implement check against XCCDF check-content. Source rule SV-06030313r1_rule.'
  end
end
