...
control 'C-5.1.1' do
  ...
  describe 'Ensure permissions on /etc/ssh/sshd_config are configured' do
    skip 'TODO[scaffolder]: implement check against XCCDF check-content. Source rule SV-050101r1_rule.'
  end
end
