...
control 'C-1.1.2.5.4' do
  ...
  describe 'Ensure noexec option set on /var/tmp partition' do
    skip 'TODO[scaffolder]: implement check against XCCDF check-content. Source rule SV-0101020504r1_rule.'
  end
end
