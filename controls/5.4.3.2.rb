...
control 'C-5.4.3.2' do
  ...
  tag cis_rule_id:           'SV-05040302r1_rule'
  tag cis_version:           '2.0.0'
  tag cis_level:             1
  tag cis_scored:            true

  describe 'Ensure default user shell timeout is configured' do
    skip 'TODO[scaffolder]: implement check against XCCDF check-content. Source rule SV-05040302r1_rule.'
  end
end
