...
control 'C-1.1.2.6.4' do
  ...
  describe 'Ensure noexec option set on /var/log partition' do
    skip 'TODO[scaffolder]: implement check against XCCDF check-content. Source rule SV-0101020604r1_rule.'
  end
end
