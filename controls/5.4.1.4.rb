...
control 'C-5.4.1.4' do
  ...
  describe 'Ensure strong password hashing algorithm is configured' do
    skip 'TODO[scaffolder]: implement check against XCCDF check-content. Source rule SV-05040104r1_rule.'
  end
end
