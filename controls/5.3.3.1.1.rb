...
control 'C-5.3.3.1.1' do
  ...
  describe 'Ensure password failed attempts lockout is configured' do
    skip 'TODO[scaffolder]: implement check against XCCDF check-content. Source rule SV-0503030101r1_rule.'
  end
end
