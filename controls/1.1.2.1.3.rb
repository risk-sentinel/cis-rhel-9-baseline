...
control 'C-1.1.2.1.3' do
  ...
  describe 'Ensure nosuid option set on /tmp partition' do
    skip 'TODO[scaffolder]: implement check against XCCDF check-content. Source rule SV-0101020103r1_rule.'
  end
end
