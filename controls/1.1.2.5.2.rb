...
control 'C-1.1.2.5.2' do
  ...
  describe 'Ensure nodev option set on /var/tmp partition' do
    skip 'TODO[scaffolder]: implement check against XCCDF check-content. Source rule SV-0101020502r1_rule.'
  end
end
