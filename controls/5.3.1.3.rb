...
control 'C-5.3.1.3' do
  ...
  describe 'Ensure latest version of libpwquality is installed' do
    skip 'TODO[scaffolder]: implement check against XCCDF check-content. Source rule SV-05030103r1_rule.'
  end
end
