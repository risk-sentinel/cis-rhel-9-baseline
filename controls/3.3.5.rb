...
control 'C-3.3.5' do
  ...
  tag cis_rid:               '3.3.5'
  tag cis_number:            '3.3.5'
  tag cis_benchmark:         'CIS Red Hat Enterprise Linux 9 Benchmark v2.0.0'
  tag cis_rule_id:           'SV-030305r1_rule'
  tag cis_version:           '2.0.0'
  tag cis_level:             1
  tag cis_scored:            true

  describe 'Ensure icmp redirects are not accepted' do
    skip 'TODO[scaffolder]: implement check against XCCDF check-content. Source rule SV-030305r1_rule.'
  end
end
