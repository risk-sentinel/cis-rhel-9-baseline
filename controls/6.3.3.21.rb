...
control 'C-6.3.3.21' do
  ...
  describe 'Ensure the running and on disk configuration is the same' do
    skip 'TODO[scaffolder]: implement check against XCCDF check-content. Source rule SV-06030321r1_rule.'
  end
end
