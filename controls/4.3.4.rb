...
control 'C-4.3.4' do
  ...
  describe 'Ensure nftables loopback traffic is configured' do
    skip 'TODO[scaffolder]: implement check against XCCDF check-content. Source rule SV-040304r1_rule.'
  end
end
