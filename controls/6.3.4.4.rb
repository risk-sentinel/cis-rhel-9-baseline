...
control 'C-6.3.4.4' do
  ...
  describe 'Ensure audit log files group owner is configured' do
    skip 'TODO[scaffolder]: implement check against XCCDF check-content. Source rule SV-06030404r1_rule.'
  end
end
