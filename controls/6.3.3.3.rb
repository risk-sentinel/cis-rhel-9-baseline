...
control 'C-6.3.3.3' do
  ...
  describe 'Ensure events that modify the sudo log file are collected' do
    skip 'TODO[scaffolder]: implement check against XCCDF check-content. Source rule SV-06030303r1_rule.'
  end
end
