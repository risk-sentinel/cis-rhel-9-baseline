...
control 'C-6.3.3.11' do
  ...
  describe 'Ensure session initiation information is collected' do
    skip 'TODO[scaffolder]: implement check against XCCDF check-content. Source rule SV-06030311r1_rule.'
  end
end
