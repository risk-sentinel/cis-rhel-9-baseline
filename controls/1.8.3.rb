...
control 'C-1.8.3' do
  ...
  describe 'Ensure GDM disable-user-list option is enabled' do
    skip 'TODO[scaffolder]: implement check against XCCDF check-content. Source rule SV-010803r1_rule.'
  end
end
