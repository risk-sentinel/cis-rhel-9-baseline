...
control 'C-2.4.1.2' do
  ...
  describe 'Ensure permissions on /etc/crontab are configured' do
    skip 'TODO[scaffolder]: implement check against XCCDF check-content. Source rule SV-02040102r1_rule.'
  end
end
