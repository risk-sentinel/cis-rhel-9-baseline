...
control 'C-1.6.6' do
  ...
  describe 'Ensure system wide crypto policy disables chacha20-poly1305 for ssh' do
    skip 'TODO[scaffolder]: implement check against XCCDF check-content. Source rule SV-010606r1_rule.'
  end
end
