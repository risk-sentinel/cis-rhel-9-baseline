...
control 'C-1.1.2.2.3' do
  ...
  describe 'Ensure nosuid option set on /dev/shm partition' do
    skip 'TODO[scaffolder]: implement check against XCCDF check-content. Source rule SV-0101020203r1_rule.'
  end
end
