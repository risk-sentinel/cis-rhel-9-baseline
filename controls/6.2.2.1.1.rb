...
control 'C-6.2.2.1.1' do
  ...
  describe 'Ensure systemd-journal-remote is installed' do
    skip 'TODO[scaffolder]: implement check against XCCDF check-content. Source rule SV-0602020101r1_rule.'
  end
end
