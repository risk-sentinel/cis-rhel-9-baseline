...
control 'C-5.3.1.2' do
  ...
  describe 'Ensure latest version of authselect is installed' do
    skip 'TODO[scaffolder]: implement check against XCCDF check-content. Source rule SV-05030102r1_rule.'
  end
end
