...
control 'C-1.1.2.3.1' do
  ...
  describe 'Ensure separate partition exists for /home' do
    skip 'TODO[scaffolder]: implement check against XCCDF check-content. Source rule SV-0101020301r1_rule.'
  end
end
