...
control 'C-1.7.1' do
  ...
  describe 'Ensure message of the day is configured properly' do
    skip 'TODO[scaffolder]: implement check against XCCDF check-content. Source rule SV-010701r1_rule.'
  end
end
