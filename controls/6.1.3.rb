...
control 'C-6.1.3' do
  ...
  describe 'Ensure cryptographic mechanisms are used to protect the integrity of audit tools' do
    skip 'TODO[scaffolder]: implement check against XCCDF check-content. Source rule SV-060103r1_rule.'
  end
end
