...
control 'C-1.1.2.5.1' do
  ...
  describe 'Ensure separate partition exists for /var/tmp' do
    skip 'TODO[scaffolder]: implement check against XCCDF check-content. Source rule SV-0101020501r1_rule.'
  end
end
