...
control 'C-6.3.4.5' do
  ...
  describe 'Ensure audit configuration files mode is configured' do
    skip 'TODO[scaffolder]: implement check against XCCDF check-content. Source rule SV-06030405r1_rule.'
  end
end
