...
control 'C-5.4.1.3' do
  ...
  describe 'Ensure password expiration warning days is configured' do
    skip 'TODO[scaffolder]: implement check against XCCDF check-content. Source rule SV-05040103r1_rule.'
  end
end
