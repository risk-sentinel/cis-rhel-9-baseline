...
control 'C-1.1.2.6.2' do
  ...
  describe 'Ensure nodev option set on /var/log partition' do
    skip 'TODO[scaffolder]: implement check against XCCDF check-content. Source rule SV-0101020602r1_rule.'
  end
end
