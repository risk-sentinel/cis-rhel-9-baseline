...
control 'C-6.3.3.18' do
  ...
  tag cis_rid:               '6.3.3.18'
  tag cis_number:            '6.3.3.18'
  tag cis_benchmark:         'CIS Red Hat Enterprise Linux 9 Benchmark v2.0.0'
  tag cis_rule_id:           'SV-06030318r1_rule'
  tag cis_version:           '2.0.0'
  tag cis_level:             1
  tag cis_scored:            true

  describe 'Ensure successful and unsuccessful attempts to use the usermod command are collected' do
    skip 'TODO[scaffolder]: implement check against XCCDF check-content. Source rule SV-06030318r1_rule.'
  end
end
