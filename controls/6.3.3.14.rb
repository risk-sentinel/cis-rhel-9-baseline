...
control 'C-6.3.3.14' do
  ...
  describe 'Ensure events that modify the system\'s Mandatory Access Controls are collected' do
    skip 'TODO[scaffolder]: implement check against XCCDF check-content. Source rule SV-06030314r1_rule.'
  end
end
