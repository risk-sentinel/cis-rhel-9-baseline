...
control 'C-6.3.3.12' do
  ...
  describe 'Ensure login and logout events are collected' do
    skip 'TODO[scaffolder]: implement check against XCCDF check-content. Source rule SV-06030312r1_rule.'
  end
end
