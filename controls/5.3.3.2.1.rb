...
control 'C-5.3.3.2.1' do
  ...
  describe 'Ensure password number of changed characters is configured' do
    skip 'TODO[scaffolder]: implement check against XCCDF check-content. Source rule SV-0503030201r1_rule.'
  end
end
