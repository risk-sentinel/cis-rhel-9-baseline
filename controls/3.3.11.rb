...
control 'C-3.3.11' do
  ...
  describe 'Ensure ipv6 router advertisements are not accepted' do
    skip 'TODO[scaffolder]: implement check against XCCDF check-content. Source rule SV-030311r1_rule.'
  end
end
