...
control 'C-5.1.12' do
  ...
  describe 'Ensure sshd HostbasedAuthentication is disabled' do
    skip 'TODO[scaffolder]: implement check against XCCDF check-content. Source rule SV-050112r1_rule.'
  end
end
