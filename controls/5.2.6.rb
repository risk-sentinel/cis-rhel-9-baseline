...
control 'C-5.2.6' do
  ...
  describe 'Ensure sudo authentication timeout is configured correctly' do
    skip 'TODO[scaffolder]: implement check against XCCDF check-content. Source rule SV-050206r1_rule.'
  end
end
