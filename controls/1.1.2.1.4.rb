...
control 'C-1.1.2.1.4' do
  ...
  describe 'Ensure noexec option set on /tmp partition' do
    skip 'TODO[scaffolder]: implement check against XCCDF check-content. Source rule SV-0101020104r1_rule.'
  end
end
