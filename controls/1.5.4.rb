...
control 'C-1.5.4' do
  ...
  tag cci:                   ['CCI-000366']
  tag cis_rid:               '1.5.4'
  tag cis_number:            '1.5.4'
  tag cis_benchmark:         'CIS Red Hat Enterprise Linux 9 Benchmark v2.0.0'
  tag cis_rule_id:           'SV-010504r1_rule'
  tag cis_version:           '2.0.0'
  tag cis_level:             1
  tag cis_scored:            true

  describe 'Ensure core dump storage is disabled' do
    skip 'TODO[scaffolder]: implement check against XCCDF check-content. Source rule SV-010504r1_rule.'
  end
end
