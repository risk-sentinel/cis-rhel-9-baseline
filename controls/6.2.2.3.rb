...
control 'C-6.2.2.3' do
  ...
  tag ksi:                   ['KSI-CMT-LMC', 'KSI-IAM-AAM', 'KSI-IAM-APM', 'KSI-IAM-JIT', 'KSI-IAM-SNU', 'KSI-IAM-SUS', 'KSI-MLA-LET', 'KSI-MLA-OSM', 'KSI-MLA-RVL']
  tag nist_r4:               ['AC-2 (2)', 'AC-2 f', 'AU-2 a', 'AU-4', 'IA-2 (2)']
