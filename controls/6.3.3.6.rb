...
control 'C-6.3.3.6' do
  ...
  describe 'Ensure use of privileged commands are collected' do
    skip 'TODO[scaffolder]: implement check against XCCDF check-content. Source rule SV-06030306r1_rule.'
  end
end
