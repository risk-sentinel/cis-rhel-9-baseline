...
control 'C-5.3.3.1.3' do
  ...
  describe 'Ensure password failed attempts lockout includes root account' do
    skip 'TODO[scaffolder]: implement check against XCCDF check-content. Source rule SV-0503030103r1_rule.'
  end
end
