...
control 'C-1.1.2.7.2' do
  ...
  describe 'Ensure nodev option set on /var/log/audit partition' do
    skip 'TODO[scaffolder]: implement check against XCCDF check-content. Source rule SV-0101020702r1_rule.'
  end
end
