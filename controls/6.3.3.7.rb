...
control 'C-6.3.3.7' do
  ...
  describe 'Ensure unsuccessful file access attempts are collected' do
    skip 'TODO[scaffolder]: implement check against XCCDF check-content. Source rule SV-06030307r1_rule.'
  end
end
