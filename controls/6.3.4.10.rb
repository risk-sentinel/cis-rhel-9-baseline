...
control 'C-6.3.4.10' do
  ...
  describe 'Ensure audit tools group owner is configured' do
    skip 'TODO[scaffolder]: implement check against XCCDF check-content. Source rule SV-06030410r1_rule.'
  end
end
