...
control 'C-6.2.2.1.3' do
  ...
  describe 'Ensure systemd-journal-upload is enabled and active' do
    skip 'TODO[scaffolder]: implement check against XCCDF check-content. Source rule SV-0602020103r1_rule.'
  end
end
