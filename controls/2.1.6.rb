...
control 'C-2.1.6' do
  ...
  describe 'Ensure samba file server services are not in use' do
    skip 'TODO[scaffolder]: implement check against XCCDF check-content. Source rule SV-020106r1_rule.'
  end
end
