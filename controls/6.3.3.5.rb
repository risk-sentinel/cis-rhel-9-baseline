...
control 'C-6.3.3.5' do
  ...
  describe 'Ensure events that modify the system\'s network environment are collected' do
    skip 'TODO[scaffolder]: implement check against XCCDF check-content. Source rule SV-06030305r1_rule.'
  end
end
