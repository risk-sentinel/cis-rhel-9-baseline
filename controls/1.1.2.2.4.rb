...
control 'C-1.1.2.2.4' do
  ...
  describe 'Ensure noexec option set on /dev/shm partition' do
    skip 'TODO[scaffolder]: implement check against XCCDF check-content. Source rule SV-0101020204r1_rule.'
  end
end
