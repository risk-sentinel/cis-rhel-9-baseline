...
control 'C-3.3.4' do
  ...
  tag cis_rid:               '3.3.4'
  tag cis_number:            '3.3.4'
  tag cis_benchmark:         'CIS Red Hat Enterprise Linux 9 Benchmark v2.0.0'
  tag cis_rule_id:           'SV-030304r1_rule'
  tag cis_version:           '2.0.0'
  tag cis_level:             1
  tag cis_scored:            true

  describe 'Ensure broadcast icmp requests are ignored' do
    skip 'TODO[scaffolder]: implement check against XCCDF check-content. Source rule SV-030304r1_rule.'
  end
end
