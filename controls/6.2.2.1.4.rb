...
control 'C-6.2.2.1.4' do
  ...
  describe 'Ensure systemd-journal-remote service is not in use' do
    skip 'TODO[scaffolder]: implement check against XCCDF check-content. Source rule SV-0602020104r1_rule.'
  end
end
