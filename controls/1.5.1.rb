...
control 'C-1.5.1' do
  ...
  describe 'Ensure address space layout randomization is enabled' do
    skip 'TODO[scaffolder]: implement check against XCCDF check-content. Source rule SV-010501r1_rule.'
  end
end
