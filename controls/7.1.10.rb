...
control 'C-7.1.10' do
  ...
  describe 'Ensure permissions on /etc/security/opasswd are configured' do
    skip 'TODO[scaffolder]: implement check against XCCDF check-content. Source rule SV-070110r1_rule.'
  end
end
