...
control 'C-5.1.3' do
  ...
  describe 'Ensure permissions on SSH public host key files are configured' do
    skip 'TODO[scaffolder]: implement check against XCCDF check-content. Source rule SV-050103r1_rule.'
  end
end
