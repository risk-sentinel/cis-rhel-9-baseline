...
control 'C-6.3.3.4' do
  ...
  describe 'Ensure events that modify date and time information are collected' do
    skip 'TODO[scaffolder]: implement check against XCCDF check-content. Source rule SV-06030304r1_rule.'
  end
end
