...
control 'C-6.3.3.20' do
  ...
  describe 'Ensure the audit configuration is immutable' do
    skip 'TODO[scaffolder]: implement check against XCCDF check-content. Source rule SV-06030320r1_rule.'
  end
end
