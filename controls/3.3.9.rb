...
control 'C-3.3.9' do
  ...
  tag cis_rule_id:           'SV-030309r1_rule'
  tag cis_version:           '2.0.0'
  tag cis_level:             1
  tag cis_scored:            true

  describe 'Ensure suspicious packets are logged' do
    skip 'TODO[scaffolder]: implement check against XCCDF check-content. Source rule SV-030309r1_rule.'
  end
end
