...
control 'C-6.3.3.8' do
  ...
  describe 'Ensure events that modify user/group information are collected' do
    skip 'TODO[scaffolder]: implement check against XCCDF check-content. Source rule SV-06030308r1_rule.'
  end
end
