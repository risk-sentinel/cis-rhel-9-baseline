...
control 'C-1.1.2.2.2' do
  ...
  describe 'Ensure nodev option set on /dev/shm partition' do
    skip 'TODO[scaffolder]: implement check against XCCDF check-content. Source rule SV-0101020202r1_rule.'
  end
end
