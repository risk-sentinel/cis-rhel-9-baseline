...
control 'C-2.4.1.6' do
  ...
  describe 'Ensure permissions on /etc/cron.monthly are configured' do
    skip 'TODO[scaffolder]: implement check against XCCDF check-content. Source rule SV-02040106r1_rule.'
  end
end
