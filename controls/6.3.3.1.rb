...
control 'C-6.3.3.1' do
  ...
  describe 'Ensure changes to system administration scope (sudoers) is collected' do
    skip 'TODO[scaffolder]: implement check against XCCDF check-content. Source rule SV-06030301r1_rule.'
  end
end
